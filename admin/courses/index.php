        ...
        <div class="container-fluid">
			<table class="table table-hover table-striped table-bordered" id="list">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT c.*, d.name as `department` from `course_list` c inner join department_list d on c.department_id = d.id where c.delete_flag = 0 and d.delete_flag = 0 order by d.`name` asc,c.`name` asc ");
